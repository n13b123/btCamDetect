...
import com.example.victor.btcamdetect.data.GlobalData;
import com.example.victor.btcamdetect.data.Preferences;
import com.example.victor.btcamdetect.detection.AggregateLumaMotionDetection;
import com.example.victor.btcamdetect.detection.IMotionDetection;
    ...
    private SurfaceHolder.Callback surfaceCallback = new SurfaceHolder.Callback() {
        ...
        public void surfaceCreated(SurfaceHolder holder) {
            try {
                ...
                Log.e("PreviewDemo-surCback", "Exception in setPreviewDisplay()", t);
            }
        }
        ...
        public void run() {
            ...
            try {
                ...
                if (img != null && detector.detect(img, width, height)) {
                   // TextView txt = (TextView) findViewById(R.id.preview);
